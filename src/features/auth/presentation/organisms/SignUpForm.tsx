...
export function SignUpForm({ className, ...props }: React.ComponentProps<'div'>) {
  ...
  const handleFieldChange = (field: string, value: string) => {
    ...
    setError(null); // Clear global error when fields change
  };
  ...
  return (
    <div className={cn('flex flex-col gap-6', className)} {...props}>
      <Card className="overflow-hidden">
        <CardContent className="grid p-0">
          <div className="flex flex-col items-center text-center gap-2">
            <h1 className="text-2xl font-bold py-2 mt-3">Create an account</h1>
            <p className="text-balance text-muted-foreground">Sign up for your Hopper account</p>
          </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="grid gap-2 mt-4">
                ...
                <Input
                  ...
                  required
                  className={`border-gray-300 ${fieldErrors.password ? 'border-red-500' : ''}`}
                />
              ...
              <div className="grid gap-2 mt-4">
                ...
                <Input
                  ...
                  required
                  className={cn('border-gray-300', fieldErrors.confirmPassword && 'border-red-500')}
                />
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                <Button variant="outline" className="w-full mt-" disabled>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
      ...
      <div className="text-balance text-center text-xs text-muted-foreground [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:text-primary mt-3">
