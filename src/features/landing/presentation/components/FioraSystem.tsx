...
export const FioraSystem = () => {
  const elements = [
    { name: 'Expense', color: 'bg-red-500' },
    { name: 'Income', color: 'bg-blue-500' },
    { name: 'Reconciliation', color: 'bg-yellow-500' },
    { name: 'Reporting', color: 'bg-purple-500' },
    { name: 'Payment', color: 'bg-green-500' },
    { name: 'Finance Margin', color: 'bg-pink-500' },
    { name: 'Investment', color: 'bg-orange-500' },
    { name: 'Marketing & Sale Automation', color: 'bg-teal-500' },
  ];
