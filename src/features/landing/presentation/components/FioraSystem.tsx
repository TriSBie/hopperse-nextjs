      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            <div className="inline-flex items-center gap-3 pb-3 before:h-px before:w-8 before:bg-gradient-to-r before:from-transparent before:to-green-300/50 after:h-px after:w-8 after:bg-gradient-to-l after:from-transparent after:to-pink-300/50">
            ...
            <h2 className="bg-gradient-to-r from-green-500 via-gray-300 to-pink-500 bg-clip-text text-transparent pb-4 font-nacelle text-3xl font-semibold md:text-4xl">
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            <article>
              ...
              <h3 className="mb-1 font-nacelle text-[1rem] font-semibold  text-green-700 dark:text-gray-200">
                Project Milestones
              </h3>
              <p className="text-gray-600 dark:text-indigo-200/65">
                Track progress across custom flows for your team. Find the right balance for the
